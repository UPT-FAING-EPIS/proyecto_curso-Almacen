<!DOCTYPE html>
<html lang="en"><%--Inicio Diego Andre Aranda Reyes--%>
<head>
<meta charset="utf-8">
          ...
          <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <p class="animate__animated animate__fadeInUp">Somos una gran familia apasionada por la comida, dispuestos a complacer tu exigente paladar con nuestras deliciosas brasas y parrillas preparadas con insumos de alta calidad, en un ambiente acogedor que har�n que disfrutes una experiencia �nica.</p>
                <div>
          ...
          <div class="carousel-item" style="background-image: url(assets/img/slide/slide-2.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <p class="animate__animated animate__fadeInUp">Pregunte por nuestras promociones. Y sal de lo tradicional.Tenemos combinaciones con arroz chaufa, Camotitos fritos y muchos m�s.</p>
                <div>
                  <a href="#menu" class="btn-menu animate__animated animate__fadeInUp scrollto">Our Menu</a>
                </div>
              </div>
          ...
          <div class="carousel-item" style="background-image: url(assets/img/slide/slide-3.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <p class="animate__animated animate__fadeInUp">En parrillas les ofrecemos nuestras presentaciones en media parrilla y parrilla familiar las cuales contienen diferentes cortes seg�n la presentaci�n (cortes de res, chuletas de cerdo, filete de pollo, chorizos, salchichas, mollejitas, antichuchos, brochetas de pollo.</p>
                <div>
                  <a href="#menu" class="btn-menu animate__animated animate__fadeInUp scrollto">Our Menu</a>
                </div>
              </div>
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <p class="animate__animated animate__fadeInUp"> Lomo saltado, Tallarin saltado, Arroz chaufa, fetuccini al pesto con churrasco, fetuccini a la huanca�na con lomo saltado,  entre otros.</p>
                <div>
                  <a href="#menu" class="btn-menu animate__animated animate__fadeInUp scrollto">Our Menu</a>
                </div>
              </div>
      ...
      <div class="container">
        ...
        <div class="row menu-container">
          ...
          <div class="col-lg-6 menu-item filter-bebidas">
            ...
            <div class="menu-ingredients">
                 JUGO SURTIDO 1/2L DE NARANJA + PI�A + FRESA
            </div>
          </div>
              <div class="col-lg-6 menu-item filter-bebidas">
            <div class="menu-content">
            ...
            <div class="menu-ingredients">
                 JUGO SURTIDO 1/2L DE PAPAYA + NARANJA + PL�TANO
            </div>
          </div> 
               <div class="col-lg-6 menu-item filter-bebidas">
            <div class="menu-content">
            ...
            <div class="menu-ingredients">
                 JUGO SURTIDO 1/2L DE PI�A + FRESA + PL�TANO + PAPAYA
            </div>
          </div> 
          ...
          <div class="col-lg-6 menu-item filter-ensaladas">
            ...
            <div class="menu-ingredients">
                 MIXTURA DE LECHUGAS + TOMATE + JAM�N + QUESO + FILETE DE PECHUGA EN TROZOS.
            </div>
          </div>
          <div class="col-lg-6 menu-item filter-ensaladas">
            <div class="menu-content">
          ...
          <div class="col-lg-6 menu-item filter-parrillas">
            ...
            <div class="menu-ingredients">
              1 BIFE + 1 CHULETA + 1/2 POLLO + 1 CHORIZO + PAPA FRITAS + 1 FRANKFURTER + ENSALADA CL�SICA CON PALTA + GRATIS 2 PIEZAS DE PAN CAMPESINO.
            </div>
          </div>
          ...
          <div class="col-lg-6 menu-item filter-parrillas">
           ...
           <div class="col-lg-6 menu-item filter-parrillas">
            ...
            <div class="menu-ingredients">
              1/2 POLLO A LA BRASA + PALITOS DE ANTICUCHO + 1 SALCHICHA + 1 CHORIZO + PANCITA + PAPAS FRITAS + ENSALADA CL�SICA CON PALTA + GRATIS 2 PIEZAS DE PAN CAMPESINO
            </div>
          </div>
          <div class="col-lg-6 menu-item filter-parrillas">
            <div class="menu-content">
            ...
            <div class="menu-ingredients">
              2 BIFES + 2 CHULETAS + 2 PECHUGAS DE POLLO + 2 CHORIZOS + 2 FRANKFURTERS + PAPAS FRITAS + ENSALADA CL�SICA CON PALTA + GRATIS 4 PIEZAS DE PAN CAMPESINO
            </div>
          </div>
          ...
          <div class="col-lg-6 menu-item filter-parrillas">
            ...
            <div class="menu-ingredients">
              1 BIFE+ 1 CHULETA + 1 PECHUGA DE POLLO + 1 CHORIZO + 1 FRANKFURTER + PAPAS FRITAS + ENSALADA CL�SICA CON PALTA + GRATIS 2 PIEZAS DE PAN CAMPESINO.
            </div>
          </div>
          <div class="col-lg-6 menu-item filter-specialty">
            <div class="menu-content">
              ...
              <div class="tab-pane" id="tab-3">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    ...
                    <p class="fst-italic">10 PIEZAS BROASTER + PORCI�N DE PAPAS + GASEOSA</p>
