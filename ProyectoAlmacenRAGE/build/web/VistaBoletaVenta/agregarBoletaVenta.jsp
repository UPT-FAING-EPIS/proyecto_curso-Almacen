...
<html lang="en">
  ...
  <body>
        <%@ include file="../header/header.jsp"%>
          ...
          <nav id="sidebar" aria-label="Site menu">
        <!-- Sidebar Header-->
        <div class="sidebar-header d-flex align-items-center p-4"><img class="avatar shadow-0 img-fluid rounded-circle" src="img/avatar-6.jpg" alt="...">
          <div class="ms-3 title">
            <h1 class="h5 mb-1">Erick Mamanii</h1>
              ...
              <div class="container-fluid py-2">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0 py-3 px-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Boleta Venta</li>
                  </ol>
                </nav>
              </div>
                ...
                <div class="col-lg-12">
                  <div class="card mb-0">
                    <div class="card-header">
                      <h2 class="h2 mb-0 text-center">Agregar Boleta Venta</h2>
                    </div>
                    ...
                    <div class="card-body pt-0">
                      <form action="Controlador" class="form-horizontal">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" name="txtSerieboleta" required>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                              <input class="form-control" type="number" min="1"  name="txtFkidpedido" required>
                          </div>
                        </div>                   
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <div class="input-group">
                              <input class="form form-control" type="date" name="txtFechaemision" required>
                            </div>                          
                          </div>
                        </div>     
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                              <input class="form-control" type="number" min="0"  step="any" name="txtTotal" required>
                          </div>
                        </div>   
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                              <input class="form-control" type="number" min="0" step="any"  name="txtImpuesto" required>
                          </div>
                        </div>   
                        <input type="hidden" name="accion" value="AgregarBoletaVenta">
                        <div class="my-4"></div>
                        ...
                        <div class="container-fluid py-2">
                          <div class="modal-footer">
                            ...
                            <input class="btn btn-primary" name="AgregarBoletaVentaDB" value="AgregarBoletaVentaDB" type="submit"/>
                          </div>
                        </div>
