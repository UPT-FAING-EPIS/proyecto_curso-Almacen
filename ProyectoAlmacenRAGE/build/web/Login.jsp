                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-12 col-xs-12 c2 px-5 pt-5">
                       <form action="Controlador" >
                        ...
                        <div class="form-group mb-3">
                            <label class="font-weight-bold"style="color:black">Contrase�a <span class="text-danger">*</span></label>
                            <input name="txtPassword" type="password" class="form-control" placeholder="Ingresa tu contrase�a">
                        </div>                        
                        ...
                        <input type="hidden" name="accion" value="LogearUsuario">
                         ...
                         <a href="index.jsp" type="submit" class="">Volver</a>      
                    </form> 
                    </div>
                </div>
            </div>
