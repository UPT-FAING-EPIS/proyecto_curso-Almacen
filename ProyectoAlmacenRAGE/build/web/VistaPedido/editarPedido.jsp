            ...
            ped=dao.list(Integer.parseInt((String) request.getAttribute("idped")));
                      ...
                      <form action="Controlador" class="form-horizontal">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                              <input class="form-control" type="number" value="<%=ped.getIdpedido()%>" min="1"  name="txtPedido" required >
                          </div>
                        </div>
                      ...
                      <div class="my-4"></div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" value="<%=ped.getEstado()%>" name="txtEstado" required>
                          </div>
