  ...
  <div class="page-content">
    <div class="container" >
        <div class="row" >
            ...
            <div>                
              <img src="img/pollo.png" alt="imagen de pollo"/>                
              <section>               
              <h4>Somos una gran familia apasionada por la comida, dispuestos a complacer tu exigente paladar con nuestras deliciosas brasas y parrillas preparadas con insumos de alta calidad, en un ambiente acogedor que har�n que disfrutes una experiencia �nica.</h4>
