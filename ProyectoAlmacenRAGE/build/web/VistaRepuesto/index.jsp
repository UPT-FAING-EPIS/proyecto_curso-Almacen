                            ...
                            <div class="card-body pt-0">
                                <div class="table-responsive">
                                    ...
                                    <table class="table mb-0 table-striped table-hover">
                                        <caption>Vista de repuesto</caption>
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <%=rep.getFkidalmacen()%>   </td>
                                                <td> <%=rep.getFkidestado()%>   </td>
                                                <td> <%=rep.getNombre()%>   </td>
                                                <td> <%=rep.getFkidcategoria()%>   </td>
                                                <td> <%=rep.getImagen()%>   </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="Controlador?accion=EliminarRepuesto&txtid=<%=rep.getIdrepuesto()%>"><i class="fa fa-trash icon-ls"></i></a>
                                                </td>
